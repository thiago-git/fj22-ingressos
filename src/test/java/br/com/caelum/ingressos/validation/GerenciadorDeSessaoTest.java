package br.com.caelum.ingressos.validation;
...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes() {
		this.rogueOne = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", new BigDecimal("120.0"));
	...
	@Test
	public void garanteQueNaoDevePermitirSesssaoNoMesmoHorario() {
